...
// A decoupled Single Page Application (SPA) separates the front-end user interface (built with tools like React, Vue, or Angular) from the back-end server logic (such as Python, Node.js, or Java). They communicate solely through an API, like REST or GraphQL, allowing independent development, deployment, and scaling.

// here we are making SPA using normal js only
